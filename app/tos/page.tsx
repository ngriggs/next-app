...
const TermsOfService: React.FC = () => {
	return (
		<div className="container mx-auto p-10">
			<h2 className="text-lg font-bold mb-5">Terms of Service</h2>
			<p>
				Please read these Terms of Service carefully before using Giggles Play's
				website. Your access to and use of the Service is conditioned on your
				acceptance of and compliance with these Terms. These Terms apply to all
				visitors, users, and others who access or use the Service.
			</p>
			<h3 className="text-lg font-bold mt-10 mb-3">Content</h3>
			<p>
			...
			<h3 className="text-lg font-bold mt-10 mb-3">Use of Service</h3>
			<p>
			...
			<h3 className="text-lg font-bold mt-10 mb-3">Limitation of Liability</h3>
			<p>
