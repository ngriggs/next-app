...
const TermsOfService: React.FC = () => {
  return (
    <div className="container mx-auto p-10">
      <h2 className="mb-5 text-lg font-bold">Terms of Service</h2>
      <p>
        Please read these Terms of Service carefully before using Giggles
        Play&apos;s website. Your access to and use of the Service is
      ...
      <h3 className="mt-10 mb-3 text-lg font-bold">Content</h3>
      <p>
        Our Service allows you to post, link, store, share, and otherwise make
        available content. You are responsible for the content that you make
        available through the Service, including its legality, reliability, and
        appropriateness.
      </p>
      <h3 className="mt-10 mb-3 text-lg font-bold">Use of Service</h3>
      <p>
        You must not use our Service for any illegal or unauthorized purpose nor
        may you, in the use of the Service, violate any laws in your
        jurisdiction (including but not limited to copyright laws).
      </p>
      <h3 className="mt-10 mb-3 text-lg font-bold">Limitation of Liability</h3>
      <p>
        In no event shall Giggles Play, nor its directors, employees, partners,
