...
const hero2 = () => {
	return (
		<div className="relative left-[calc(-50vw_+_50%)] flex h-[800px] w-screen flex-col bg-giggles-yellow-100 sm:flex-row">
			<div className="my-auto flex-1 flex-col justify-start">
				<div className="grid place-content-center ">
					<p className="text-giggles-yellow">GIGGLES PLAY</p>
					<h1 className="tes font-summerVibesSolid text-7xl">
