      ...
      <div className="my-auto flex-1 p-4">
        <div className="grid place-content-center ">
          ...
          <div className="grid grid-cols-12 grid-rows-2 p-2">
            ...
            <p className="col-start-3 col-end-12 my-auto p-2">-Rey Mibourne</p>
          </div>
        </div>
      </div>
      <div className="my-10 ml-[10%] grid w-[90%] flex-1 place-content-center rounded-l-full bg-giggles-yellow-200 md:w-[40%]">
        <Image
          src="/gigglesLogo.svg"
          alt=""
          width={414}
