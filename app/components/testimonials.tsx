			...
			>
				<Carousel.Slide>
					<div className="flex flex-col">
						...
						<p>
							"Five year old students are traditionally in kindergarten. At that
							grade level they should be learning basic concepts in reading,
							writing and math, and also be improving."
						</p>
