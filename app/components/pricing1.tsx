    ...
    <>
      <div className="col-span-3 my-4 flex flex-col items-center rounded-2xl bg-gray-100 py-9 px-12 text-gray-600 shadow-xl md:col-span-1 ">
        ...
        <Button
          variant={"giggles"}
          size={"lg"}
          className="bg-giggles-blue rounded-3xl text-[#232323]"
        >
          Subscribe
        </Button>
      </div>
...
const Pricing1 = () => {
  return (
    <div className="from-giggles-blue relative left-[calc(-50vw_+_50%)] flex w-screen flex-col items-center rounded-lg bg-gradient-to-tr to-giggles-red-500 py-10 px-5">
      {" "}
      {/* Container */}
      {/* :TITLE */}
